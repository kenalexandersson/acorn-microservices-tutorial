...
== Intro
This section will touch upon the concept of containerize microservices, or in other words, make them run in Docker. Doing so will give us a couple of benefits.
